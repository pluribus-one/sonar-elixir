 ...
 */
package eu.arthepsy.sonar.plugins.elixir.coverage;
...
import org.sonar.api.internal.apachecommons.io.filefilter.TrueFileFilter;
import org.sonar.api.utils.WildcardPattern;

public class ElixirFileSystem {
  private final File baseDir;
  private final WildcardPattern pattern;

  public ElixirFileSystem(File baseDir, WildcardPattern pattern) {
